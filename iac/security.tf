...
resource "aws_db_instance" "mysql_db" {
  ...
  username              = "admin"
  password              = "SecurePassword2026!" # Compliant with security standards
  
  # Structural Storage Security parameters
  storage_encrypted     = true  # Instructs AWS to enforce Encryption at Rest
  multi_az              = false # Enforces rapid, clean lab build validation
